...
//
import { sidebarConfigAdmin, sidebarConfigUser } from './SidebarConfig';
...
export default function DashboardSidebar({ isOpenSidebar, onCloseSidebar }) {
  ...
  const renderContent = (
    ...
    >
      ...
      <NavSection navConfig={user?.role === 'admin' ? sidebarConfigAdmin : sidebarConfigUser} isShow={!isCollapse} />
